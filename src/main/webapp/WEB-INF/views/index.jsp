...
<body>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    <div class="header__logo">
                        <a href="/"><img src="assets/img/mwc.jpg" alt=""></a>
                    </div>
                </div>
    ...
    <section class="hero">
        <div class="hero__slider owl-carousel">
            <div class="hero__items set-bg" data-setbg="assets/img/hero/banner-image3.jpg">
                <div class="container">
                    <div class="row">
            ...
            <div class="hero__items set-bg" data-setbg="assets/img/hero/banner-image1.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-5 col-lg-7 col-md-8">
                            <div class="hero__text">
